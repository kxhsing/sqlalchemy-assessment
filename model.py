...
class Brand(db.Model):
    ...
    def __repr__(self):
        return "<Brand brand_id={} name={} founded={} discontinued={}, headquarters={}>".format(
                                                                                        self.brand_id, 
                                                                                        self.name, 
                                                                                        self.founded,
                                                                                        self.discontinued,
...
class Model(db.Model):
    ...
    def __repr__(self):
        return "<Model model_id={} brand_id={} name={} year={}>".format(self.model_id, self.brand_id, self.name, self.year)
